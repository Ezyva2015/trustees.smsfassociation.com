...
<head>
	...
	<style type="text/css">
		@font-face {
			...
			src: url("<?php echo get_template_directory_uri(); ?>/GalaxiePolaris-Book.otf") format("opentype");
		}
		.post-content p, body p, body h1, body h2, body h3, body h4, body h5, body h6{
			font-family: 'GalaxiePolaris-Book',Helvetica,Arial !important;
		}
