	...
	<script>
		...
		jq(document).ready(function(){
			...
			jq('.fusion-main-menu-icon2').click(function(){
				
				jq('.fusion-custom-menu-item-contents2').slideToggle(100);
				
				
			})
			
			
			jq('.buttonvids').click(function(){
			
		
				jq('#video-homefp video')[0].play();		
				
			})
			
			jq('#video-homefp .fusion-button, #video-homefp .close').click(function(){
				
				jq('#video-homefp video')[0].pause();
...
<noscript><a href="http://polldaddy.com/poll/9302157/">How did you hear about us?</a></noscript>
	</body>
</html>
